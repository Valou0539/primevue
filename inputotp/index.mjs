...
import { resolveComponent, createElementBlock, openBlock, mergeProps, createCommentVNode, Fragment, renderList, renderSlot, createVNode, normalizeClass } from 'vue';
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", mergeProps({
    "class": _ctx.cx('root')
  }, _ctx.ptmi('root')), [_ctx.$formName ? (openBlock(), createElementBlock("input", {
    key: 0,
    type: "hidden",
    name: _ctx.$formName,
    value: _ctx.modelValue
  }, null, 8, _hoisted_1)) : createCommentVNode("", true), (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.length, function (i) {
    return renderSlot(_ctx.$slots, "default", {
      ...
      }, null, 8, ["value", "type", "class", "inputmode", "variant", "readonly", "disabled", "size", "invalid", "tabindex", "unstyled", "onInput", "pt"])];
    });
  }), 128))], 16);
}
